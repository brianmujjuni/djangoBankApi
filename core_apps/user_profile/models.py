...
class Profile(TimeStampedModel):
    ...
    address = models.CharField(_("Address"), max_length=255, default="Unknown")
    ...
    employement_status = models.CharField(
        _("Employement Status"),
        max_length=20,
        choices=EmployementStatus.choices,
        default=EmployementStatus.SELF_EMPLOYED,
    )
    ...
    date_of_employement = models.DateField(
        _("Date of Employement"), blank=True, null=True
    )
    ...
    photo_url = models.URLField(_("Photo URL"), max_length=255, blank=True, null=True)
