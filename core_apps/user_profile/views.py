...
from .serializers import NextOfKinSerializer, ProfileSerializer, ProfileListSerializer
...
class ProfileListAPIView(generics.ListAPIView):
    ...
    def get_queryset(self) -> List[Profile]:
        return Profile.objects.exclude(user__is_staff=True).order_by(
...
class ProfileDetailAPIView(generics.RetrieveUpdateAPIView):
    ...
    def retrieve(self, request: Request, *args: Any, **kwargs: Any) -> Response:
        ...
        serializer = self.get_serializer(instance=isinstance)
